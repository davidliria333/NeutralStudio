...
export default function Cursor() {
  ...
  useEffect(() => {
    ...
    const onMove = (e) => {
      ...
      if (dot.current) dot.current.style.visibility = 'visible'
  ...
  return (
    <>
      <div ref={dot} style={{
        ...
        background: 'var(--ink)', pointerEvents: 'none', zIndex: 9999, mixBlendMode: 'difference', visibility: 'hidden',
      }} />
      <div ref={ring} style={{
        ...
        mixBlendMode: 'difference', visibility: 'hidden',
      }} />
      <style>{`
